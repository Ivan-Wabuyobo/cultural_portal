        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <form action="" method="post">
                            <div class="col-3">
                                <div class="mb-2">
                                    <label for="floatingSelect">Listen to music from other tribes</label>
                        ...
                        <div class="row">
                            ...
                            if (isset($_POST['filter'])) {
                                $id = $_POST['tribe'];
                                $query = "SELECT * FROM `music` JOIN tribes ON music.tribe_id = tribes.tribe_id WHERE music.tribe_id = '$id' ORDER BY music_id DESC";
                            } else {
                                $query = "SELECT * FROM `music` JOIN tribes ON music.tribe_id = tribes.tribe_id WHERE music.tribe_id = '$tribe' ORDER BY music_id DESC";
                            }
                            ...
                            ?>
                                    <div class="col-12">
                                        <div class="card text-success" style="width: 30rem;">

                                            <i class='bx bx-music card-img-top bx-lg'></i>
                                            <div class="card-body">
                                                <h5 class="card-title"><?php echo $music['music_title'] ?></h5>
                                                <p class="card-text"><?php echo $music['music_description'] ?></p>
                                                <span class="text-danger">Uploaded <?php echo time_ago($music['music_added'])?> </span>
                                                <audio controls>
                                                    <source src="<?php echo $music['music_file']; ?>" type="audio/mpeg">
