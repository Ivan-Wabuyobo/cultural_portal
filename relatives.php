                ...
                <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            function time_ago($datetime)
                            {
                             ...
                             $query = "SELECT * FROM `members`  WHERE (LOWER(members.surname = '$surname') OR members.clan = '$clan') AND NOT members.id = '$userId'";
                            $results = $conn->query($query);
                            if ($results->num_rows > 0) {?>
                                <h1 class='text-warning'>Hello, <?php echo $username ?> these are your possible relatives!!!</h1>
                            ...
                            ?>
                                    <div class="col-4">
                                        <div class="card text-success">
                                            ...
                                            <i class='bx bx-user bx-lg'></i>
                                                <h5 class="card-title"><?php echo $data['surname'] ?></h5>
                                                <p class="card-text"><?php echo $data['other_names'] ?></p> 
                                                <p class='card-text'><?php echo $data['address']?></p>
                                                <p class='card-text'><?php echo $data['contact']?></p>
                                                <a href="https://wa.me/<?php echo $data['contact']?>" class="btn btn-success text-right"><i class='bx bxl-whatsapp bx-md'></i></a>
                                            </div>
                                        </div>
                                    </div>
                                <?php }
                                ...
                                <h1 class="text-danger">
                                    Sorry, we could not match you to any possible relatives who are in the system.
