        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <form action="" method="post">
                            <div class="col-3">
                                <div class="mb-2">
                                    <label for="floatingSelect">Read Articles from other tribes</label>
                        ...
                        <div class="row">
                            ...
                            if (isset($_POST['filter'])) {
                                $id = $_POST['tribe'];
                                $query = "SELECT * FROM `articles` JOIN tribes ON tribes.tribe_id = articles.tribe JOIN contributors ON contributors.id = articles.created_by WHERE articles.tribe = '$id'";
                            } else {
                                $query = "SELECT * FROM `articles` JOIN tribes ON tribes.tribe_id = articles.tribe JOIN contributors ON contributors.id = articles.created_by WHERE articles.tribe = '$tribe'";
                            }
                            ...
                            ?>
                                    <div class="col-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body ">
                                                <h5 class="card-title text-success"><?php echo $article['tittle'] ?></h5>
                                                <div class="card-text"><?php echo $article['body'] ?></div>
                                                <span class="text-danger">Uploaded <?php echo time_ago($article['article_created_at'])?> </span>
                                        <span class="text-warning"> by <?php echo $article['full_name']?></span>
