            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box text-success  px-3 font-size-16 header-item waves-effect pt-3">
                        <h2><i class="bx bx-image"></i> video Portal</h2>
                    </div>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <h2 class="text-danger"> <i class="bx bx-image-add text-warning"></i>Animations Portal</h2>
                            <p class="">Use Animations or videos to reveal to the world our beautiful diversity</p>
                            <form action="upload2.php" class="dropzone" method="post">
                                <div class="mb-3">
