            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <form action="" method="post">
                        <div class="col-3">
                            <div class="mb-2">
                                <label for="floatingSelect">View Animations and learn from content from other tribes</label>
                    ...
                    <div class="row">
                        ...
                        if (isset($_POST['filter'])) {
                            $id = $_POST['tribe'];
                            $query = "SELECT * FROM `video` JOIN tribes ON tribes.tribe_id = video.tribe JOIN contributors ON contributors.id = video.uploaded_by WHERE video.tribe = '$id' ORDER BY video.id DESC";
                        } else {
                            $query = "SELECT * FROM `video` JOIN tribes ON tribes.tribe_id = video.tribe JOIN contributors ON contributors.id = video.uploaded_by WHERE video.tribe = '$tribe' ORDER BY video.id DESC";
                        }
                        ...
                        if ($results->num_rows > 0) {
                            ...
                            while ($video = $results->fetch_assoc()) {
                        ?>
                                <div class="col-12">
                                    <div class="card text-success" style="width: 30rem;">
                                        <div class="card-body">
                                            ...
                                            <span class="text-danger">Uploaded <?php echo time_ago($video['uploaded_at']) ?> </span>
