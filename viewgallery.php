        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <form action="" method="post">
                            <div class="col-3">
                                <div class="mb-2">
                                    <label for="floatingSelect">View Gallery from other tribes</label>
                        ...
                        <div class="row">
                            ...
                            if (isset($_POST['filter'])) {
                                $id = $_POST['tribe'];
                                $query = "SELECT * FROM `gallery` JOIN tribes ON tribes.tribe_id = gallery.tribe WHERE gallery.tribe='$id' ORDER BY gallery.id ";
                            } else {
                                $query = "SELECT * FROM `gallery` JOIN tribes ON tribes.tribe_id = gallery.tribe WHERE gallery.tribe='$tribe' ORDER BY gallery.id ";
                            }
                            ...
                            if ($results->num_rows > 0) {
                                ...
                                while ($gallery = $results->fetch_assoc()) {
                            ?>
                                    <div class="col-12">
                                        <div class="card text-success" style="width: 30rem;">
                                            <div class="card-body">
                                                <h5 class="card-title"><?php echo $gallery['title'] ?></h5>
                                                <img src="<?php echo $gallery['image_name']?>" class="img-fluid rounded-top" alt="">
                                                <p class="card-text"><?php echo $gallery['description'] ?></p>
                                            
                                                <span class="text-danger">Uploaded <?php echo time_ago($gallery['uploaded_at'])?> </span>
