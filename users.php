                                ...
                                <div class="card-body">
                                    <table id="datatable" class="table table-bordered dt-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                <td hidden><?php echo $contributors['id'] ?></td>
                                                    <td hidden><?php echo $contributors['username'] ?></td>
                                                    <td hidden><?php echo $contributors['password'] ?></td>
                                                    <td><?php echo $contributors['username'] ?></td>
                                                    <td><?php echo $contributors['password'] ?></td>
                                                    <td><?php
                                                        if ($contributors['role'] == '0') {
                                                            echo "Admin";
                                                        } else if ($contributors['role'] == '1') {
                                                            echo "Contributor";
                                                        } else {
                                                            echo "Member";
                                                        }
                                                    ...
                                                    <td>
                                                        ...
                                                        echo time_ago($contributors['created_at'])
