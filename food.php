                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        if (isset($_POST['filter'])) {
                            $id = $_POST['tribe'];
                            $query = "SELECT * FROM `food` WHERE food.tribe = '$id' ORDER by food.food_id DESC";
                        } else {
                            $query = "SELECT * FROM `food` WHERE food.tribe = '$tribe' ORDER by food.food_id DESC";
                        }
                        ...
                        if ($results->num_rows > 0) {
                            ...
                            while ($food = $results->fetch_assoc()) {
                        ?>
                                <div class="col-12">
                                    <div class="card" style="width: 18rem;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            uploaded <a href="#" class=""><small><?php echo time_ago($food['uploaded_at']);?></small></a>
                                        </div>
                                    </div>
                                </div>
                    </div>
